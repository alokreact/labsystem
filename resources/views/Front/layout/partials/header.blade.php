@include('Front.Home.Components.search')
<nav class="bg-white border-gray-200 dark:bg-gray-900 mt-2">
    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div class="flex items-center justify-space">
            ...
            @guest
                <a href="{{ route('signin') }}" class="text-sm  text-blue-600 dark:text-blue-500 hover:underline ml-2">
                    <button type="button"
