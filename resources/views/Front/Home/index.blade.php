...
@section('content')
    ...
    @include('Front.Home.Components.upload-prescription')

    <div class="container mx-auto">

        @include('Front.Home.Components.banner')
...
Share your prescription with us and our team will call you to book tests for you..</p>
